...
namespace YAX
{
	...
	struct Vector4
	{
		...
		static void Transform(const std::vector<Vector4>& source, int sourceIdx, const Matrix& mat, std::vector<Vector4>& dest, int destIdx, int count);
		static void Transform(const std::vector<Vector4>& source, int sourceIdx, const Quaternion& q, std::vector<Vector4>& dest, int destIdx, int count);
		...
		static void TransformNormal(const std::vector<Vector4>& source, int sourceIdx, const Matrix& mat, std::vector<Vector4>& dest, int destIdx, int count);
